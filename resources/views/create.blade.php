        ...
        <div class="col-md-8 offset-2 mt-5">
            <div class="card">
                <div class="card-header bg-info">
                    <h5 class="text-white text-center">Create New Modal</h5>
                </div>
                <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="image-upload" method="post" action="{{ URL::to('/books/store') }}" enctype="multipart/form-data">
                        @csrf
